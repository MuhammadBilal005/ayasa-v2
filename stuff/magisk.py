...
class Magisk(General):
    ...
    # You'll need to update this MD5 hash with the actual hash of the latest version
...
on property:init.svc.zygote=stopped
    ...
    def copy(self):
        ...
        if self.machine[0] not in arch_map:
            raise ValueError("Architecture {} not supported".format(self.machine[0]))
